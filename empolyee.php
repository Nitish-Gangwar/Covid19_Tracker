<!--  This is the employee advisory page which includes the recent advisories regarding the coronavirus provided by the government of India.
    -->
<!doctype html>
<html lang="en"> 
  <head>
...
<!-- Here we are using internal style. This is used for decorating the table
    	which contains the employee advisories -->
    <style>
        	.styled-table {
  ...
  <body>
    ...
    <br>
    <div>
        <img src="Images/employee.jpg"  class="image_center">
    </div>
    <br>
    <br>
    <!--  This table shows the employee advisories! -->
    <br>
     <h2 align="center">
    Employees Advisories
    </h2>
 ...
 // mysqli_connect is used for connecting with the covid_19_database in the xampp mysql.
    ...
    $sql = "SELECT Date, Heading, Link FROM Employees_advisories";
