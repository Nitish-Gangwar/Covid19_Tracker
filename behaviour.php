<!--  This is the behaviour advisory page which includes the recent advisories regarding the coronavirus provided by the government of India.
    -->
<!doctype html>
<html lang="en"> 
  <head>
	...
	<!-- Here we are using internal style. This is used for decorating the table
    	which contains all the behavioural advisories. -->
    <style>
        	.styled-table {
  ...
  <body>
    ...
    <br>
    <div>
        <img src="Images/behavioural.jpg"  class="image_center">
    </div>
    <br>
    <br>
    <!-- This table shows the awareness advisories! -->
    <br>
      <h2 align="center">
    ...
    $sql = "SELECT Date, Heading, Link FROM Behavioural_advisories";
