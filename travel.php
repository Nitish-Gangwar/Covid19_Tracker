<!--  This is the travelling advisory page which includes the recent advisories regarding the coronavirus provided by the government of India.
    -->
...
<!-- Here we are using internal style. This is used for decorating the table
    	which contains the travelling advisories -->
    <style>
        	.styled-table {
  ...
  <body>
    ...
    <br>
    <div>
        <img src="Images/travel.png"  class="image_center">
    </div>
    <br>
    <br>
    <!--  This table shows the travelling advisories! -->
    <br>
    <h2 align="center">
    Travel Advisories
    </h2>
 ...
 // mysqli_connect is used for connecting with the covid_19_database in the xampp mysql.
    ...
    $sql = "SELECT Date, Heading, Link FROM Travel_advisories";
