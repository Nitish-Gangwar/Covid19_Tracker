<!--  This is the advisory page which includes the recent advisories regarding 
the coronavirus provided by the government of India.
    -->
...
<!-- Body starts here!! -->
  <body>
    ...
    <br>
    <br>
  <!-- This is the list of all the recent adviories given by the 
      government of India!! -->
    <div align="center">
    <h4>
    <a href="awareness.php">Awareness Advisories</a></br><br>
    <a href="behaviour.php">Behavioural Advisories</a></br><br>
    <a href="citizen.php">Citizens Advisories</a></br><br>
    <a href="empolyee.php">Employees Advisories</a></br><br>
    <a href="inspire.php">Inspirational Advisories</a></br><br>
    <a href="states.php">States Advisories</a></br><br>
    <a href="train.php">Training Advisories</a></br><br>
    </h4>
    </div>
