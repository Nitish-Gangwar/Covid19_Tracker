<!--  This is the trains advisory page which includes the recent advisories regarding the coronavirus provided by the government of India.
    -->
...
<!-- Here we are using internal style. This is used for decorating the table
    	which contains the training advisories -->
    <style>
        	.styled-table {
  ...
  <body>
    ...
    <br>
    <div>
        <img src="Images/training.png"  class="image_center">
    </div>
    <br>
    <br>
    <!--  This table shows the training advisories! -->
    <br>
     <h2 align="center">
    Training Advisories
    </h2> 
 ...
 // mysqli_connect is used for connecting with the covid_19_database in the xampp mysql.
    ...
    $sql = "SELECT Date, Heading, Link FROM Training_advisories";
